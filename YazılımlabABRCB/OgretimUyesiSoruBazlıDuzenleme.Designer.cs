...
{
	partial class OgretimUyesiSoruBazlıDuzenleme
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(OgretimUyesiSoruBazlıDuzenleme));
			...
			// 
			// OgretimUyesiSoruBazlıDuzenleme
			// 
			...
			this.Name = "OgretimUyesiSoruBazlıDuzenleme";
			this.Text = "OgretimUyesiSoruBazlıDuzenleme";
			this.Load += new System.EventHandler(this.OgretimUyesiSoruBazlıDuzenleme_Load);
